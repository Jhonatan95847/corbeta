...
Característica: Medio de Pago - Efectivo
  ...
  Narrativa: El cliente registrado en Alkosto desea realizar una compra mediante efectivo
    ...
    Ejemplos:
      ...
      | registrado |    3     | Entrega hoy       | otros datos    |  NIT    | Su Red       | PENDING |
      | registrado |    3     | Entrega hoy       | guardada       |  NIT    | Consignación | PENDING |
      | registrado |    3     | Entrega hoy       | registrada     |  NIT    | Efecty       | PENDING |
      | nuevo      |    3     | Entrega hoy       | nuevo usuario  |  NIT    | Efecty       | PENDING |
