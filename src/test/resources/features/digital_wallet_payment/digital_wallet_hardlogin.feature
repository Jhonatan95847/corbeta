 ...
 #______________________________________________________EXITOSA______________________________________________
  ...
  Narrativa: El cliente registrado en Alkosto desea realizar una compra mediante billetera digital
    ...
    Ejemplos:
      ...
      | registrado | kasado_dos            | 2        | Recoge en tienda   |  nuevo usuario  |  NIT     | Daviplata | OK   |
  ...
  Narrativa: El cliente registrado en Alkosto desea realizar una compra mediante billetera digital
    ...
    Ejemplos:
      ...
      | registrado | kombo                 | 2        | Entrega hoy        |  registrada     |  CE      | Daviplata | PENDING |
      | registrado | promocion_precio_fijo | 1        | Envio gratis       |  guardada       |  NIT     | Daviplata | PENDING |
      | registrado | pines                 | 2        | Recoge en tienda   |  nuevo usuario  |  RUT     | Daviplata | PENDING |
      | registrado | kasado                | 1        | Entrega hoy        |  guardada       |  PAS     | Daviplata | PENDING |
  ...
  Narrativa: El cliente registrado en Alkosto desea realizar una compra mediante billetera digital
    ...
    Ejemplos:
      ...
      | registrado | kasado                | 2        | Entrega hoy        |  guardada       |  NIT     | Daviplata | FAILED |
      | registrado | preventa              | 1        | Envio gratis       |  otros datos    |  RUT     | Daviplata | FAILED |
      | registrado | kasado_dos            | 2        | Recoge en tienda   |  nuevo usuario  |  PAS     | Daviplata | FAILED |
...
#______________________________________________________EXITOSA______________________________________________
  ...
  Narrativa: El cliente registrado en Alkosto desea realizar una compra mediante billetera digital
    ...
    Ejemplos:
      ...
      | registrado | kombo                 | 3        | Entrega hoy        |  registrada     |  RUT     | Nequi       | OK   |
  ...
  Narrativa: El cliente registrado en Alkosto desea realizar una compra mediante billetera digital
    ...
    Ejemplos:
      | cliente    | tipo_producto  | cantidad | metodo_envio       | direccion_envio | tipo_id         | billetera   | resultado |
      | registrado | kasado                | 3        | Entrega hoy        |  registrada     |  CC      | Nequi       | PENDING |
  ...
  Narrativa: El cliente registrado en Alkosto desea realizar una compra mediante billetera digital
    ...
    Ejemplos:
      | cliente    | tipo_producto         | cantidad | metodo_envio       | direccion_envio | tipo_id  | billetera   | resultado |
      | registrado | kasado_dos            | 1        | Entrega hoy        |  guardada       |  CC      | Nequi       | FAILED |
      | registrado | pines                 | 2        | Recoge en tienda   |  nuevo usuario  |  CE      | Nequi       | FAILED |
