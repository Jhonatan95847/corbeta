...
#______________________________________________________EXITOSA______________________________________________
  ...
  Narrativa: El cliente registrado en Alkosto desea realizar una compra mediante billetera digital
    ...
    Ejemplos:
      | cliente    | tipo_producto         | cantidad | metodo_envio       | direccion_envio | tipo_id  | billetera   | resultado |
      | registrado | normal                | 3        | Entrega hoy        |  registrada     |  CC      |Daviplata | PENDING |
      ...
      ##| registrado | normal                | 3        | Entrega hoy        |  otros datos    |  RUT     |Daviplata | PENDING |
  ...
  Narrativa: El cliente registrado en Alkosto desea realizar una compra mediante billetera digital
    ...
    Ejemplos:
      | cliente    | tipo_producto         | cantidad | metodo_envio       | direccion_envio | tipo_id  | billetera   | resultado |
      | registrado | normal                | 1        | Entrega hoy        |  guardada       |  CC      |Daviplata | FAILED |
      ##| registrado | normal                | 2        | Recoge en tienda   |  nuevo usuario  |  CE      |Daviplata | FAILED |
      ...
      | registrado | normal                | 2        | Envio gratis       |  otros datos    |  PAS     |Daviplata | FAILED |
...
#______________________________________________________EXITOSA______________________________________________
  ...
  Narrativa: El cliente registrado en Alkosto desea realizar una compra mediante billetera digital
    ...
    Ejemplos:
      | cliente    | tipo_producto         | cantidad | metodo_envio       | direccion_envio | tipo_id  | billetera   | resultado |
      | registrado | normal                | 1        | Entrega hoy        |  guardada       |  PAS     | Nequi | PENDING |
      ##| registrado | normal                | 2        | Recoge en tienda   |  nuevo usuario  |  RUT     | Nequi | PENDING |
      | registrado | promocion_precio_fijo | 1        | Envio gratis       |  guardada       |  NIT     | Nequi | PENDING |
      | registrado | normal                 | 2        | Entrega hoy        |  registrada     |  CE      | Nequi | PENDING |
