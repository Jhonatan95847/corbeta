...
@all
@codensaCard
Característica: Medio de Pago - Tarjeta Codensa
  ...
  #******************************************************HARDLOGIN*********************************************
    @tarjetaCodensaRegistradoExitosa @exitoso @tarjetaCodensa
    ...
    @tarjetaCodensaNuevoExitosa @exitoso @tarjetaCodensa
    Esquema del escenario: Compra con T Codensa
    Narrativa: El cliente registrado en Codensa
    Dado que un cliente "<cliente>" inicia sesión y desea realizar una compra
    Cuando el cliente "<cliente>" busca un producto y selecciona cantidad "<cantidad>" y método de envío "<metodoEnvio>"
 ...
 #******************************************************SOFTLOGIN*********************************************
    @tarjetaCodensaRegistradoSoftlogin @exitoso @tarjetaCodensa
    Esquema del escenario: Compra con T Codensa
    Narrativa: El cliente registrado en Codensa
    ...
    @tarjetaCodensaNuevoSoftlogin @tarjetaCodensa @exitoso
    Esquema del escenario: Compra con T Codensa
    Narrativa: El cliente registrado en Codensa
    Dado que un cliente busca un producto y selecciona cantidad "<cantidad>" y método de envío "<metodoEnvio>"
    Cuando inicia sesion y desea realizar la compra como un cliente "<cliente>"
    ...
    @tarjetaCodensaRegistradoFallido @fallido @tarjetaCodensa
    Esquema del escenario: Compra con T Codensa
    Narrativa: El cliente registrado en Codensa
    Dado que un cliente "<cliente>" inicia sesión y desea realizar una compra
    Cuando el cliente "<cliente>" busca un producto y selecciona cantidad "<cantidad>" y método de envío "<metodoEnvio>"
    ...
    @tarjetaCodensaNuevofallido @fallido @tarjetaCodensa
    Esquema del escenario: Compra con T Codensa
    Narrativa: El cliente registrado en Codensa
    Dado que un cliente "<cliente>" inicia sesión y desea realizar una compra
    Cuando el cliente "<cliente>" busca un producto y selecciona cantidad "<cantidad>" y método de envío "<metodoEnvio>"
  ...
  #******************************************************SOFTLOGIN*********************************************
    @tarjetaCodensaRegistradoSoftloginFallido @exitoso @tarjetaCodensa
    Esquema del escenario: Compra con T Codensa
    Narrativa: El cliente registrado en Codensa
    Dado que un cliente busca un producto y selecciona cantidad "<cantidad>" y método de envío "<metodoEnvio>"
    Cuando inicia sesion y desea realizar la compra como un cliente "<cliente>"
    ...
    @tarjetaCodensaNuevoSoftloginFallido @tarjetaCodensa @exitoso
    Esquema del escenario: Compra con T Codensa
    Narrativa: El cliente registrado en Codensa
    Dado que un cliente busca un producto y selecciona cantidad "<cantidad>" y método de envío "<metodoEnvio>"
    Cuando inicia sesion y desea realizar la compra como un cliente "<cliente>"
