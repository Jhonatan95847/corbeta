...
Característica: Medio de Pago - Tarjeta de Crédito con forma de logueo hard login
  ...
  #******************************************************HARDLOGIN*********************************************
  @tarjetaCreditoRegistradoExitosa @CreditoExitoso @tarjetaCreditoExitosa @CreditoNoSave
  ...
  mediante Tarjeta de Crédito con transaccion exitosa
    ...
    Ejemplos:
      ...
      | registrado | llantas               | 1        | Entrega hoy        |  guardada       |  CE      | Tarjeta de Crédito  | amex       | OK   |
      | registrado | kasado_dos            | 2        | Recoge en tienda   |  nuevo usuario  |  NIT     | Tarjeta de Crédito  | diners     | OK   |
      | registrado | cero_interes          | 3        | Envio gratis       |  registrada     |  RUT     | Tarjeta de Crédito  | mastercard | OK   |
      | registrado | promocion_porcentaje  | 1        | Entrega hoy        |  otros datos    |  PAS     | Tarjeta de Crédito  | visa       | OK   |


  @tarjetaCreditoNuevoExitosa @CreditoExitoso @tarjetaCreditoExitosa @CreditoNoSave
  Esquema del escenario: Compra con T Alkosto
  ...
  @tarjetaACreditoNuevoFallida @CreditoFallida @tarjetaCredito @CreditoNoSave
  Esquema del escenario: Compra con T Alkosto
  Narrativa: El cliente registrado en Alkosto
    Dado que un cliente "<cliente>" inicia sesión en ecomerce
    Cuando el cliente busca un producto "<tipo_producto>" y selecciona "<cantidad>" unidades
