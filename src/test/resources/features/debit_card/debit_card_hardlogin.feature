...
Característica: Medio de Pago - Tarjeta de Crédito o Debito con CVV con forma de logueo hard login
  ...
  mediante Tarjeta de Crédito o Debito con CVV con transaccion exitosa
    ...
    Ejemplos:
      ...
      | registrado | llantas               | 1        | Entrega hoy        |  guardada       |  CE      | Tarjeta de Crédito o Debito con CVV  | mastercard | OK   |
      | registrado | kasado_dos            | 2        | Recoge en tienda   |  nuevo usuario  |  NIT     | Tarjeta de Crédito o Debito con CVV  | visa       | OK   |
      | registrado | cero_interes          | 3        | Envio gratis       |  registrada     |  RUT     | Tarjeta de Crédito o Debito con CVV  | amex       | OK   |
      | registrado | promocion_porcentaje  | 1        | Entrega hoy        |  otros datos    |  PAS     | Tarjeta de Crédito o Debito con CVV  | diners     | OK   |


  @tarjetaDebitoNuevoExitosa @DebitoExitoso @tarjetaDebitoExitosa @DebitoNoSave
  Esquema del escenario: Compra con T Alkosto
  ...
  @tarjetaDebitoNuevoFallida @DebitoFallida @tarjetaDebito @DebitoNoSave
  Esquema del escenario: Compra con T Alkosto
  Narrativa: El cliente registrado en Alkosto
    Dado que un cliente "<cliente>" inicia sesión en ecomerce
    Cuando el cliente busca un producto "<tipo_producto>" y selecciona "<cantidad>" unidades
