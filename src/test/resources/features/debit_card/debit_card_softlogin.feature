...
Característica: Medio de Pago - Tarjeta de Crédito o Debito con CVV con forma de logueo hard login
  ...
  @tarjetaDebitoRegistradoExitosaSoftlogin @DebitoExitosoSoftlogin @tarjetaDebitoExitosa @DebitoNoSave
  ...
  Para recibir mis productos correctamente y disfrutar de una experiencia de compra eficiente.
    ...
    Ejemplos:
      ...
      | registrado | kasado                | 2        | Entrega hoy        |  guardada       |  NIT     | Tarjeta de Crédito o Debito con CVV  | diners     | OK   |
      | registrado | preventa              | 1        | Envio gratis       |  otros datos    |  RUT     | Tarjeta de Crédito o Debito con CVV  | mastercard | OK   |
      | registrado | kasado_dos            | 2        | Recoge en tienda   |  nuevo usuario  |  PAS     | Tarjeta de Crédito o Debito con CVV  | visa       | OK   |

  @tarjetaDebitoNuevooExitosaSoftlogin @DebitoExitosoSoftlogin @tarjetaDebitoExitosa @DebitoNoSave
  Esquema del escenario: Compra exitosa en Alkosto con métodos variados.
  Narrativa:  Como cliente registrado en Alkosto
  Quiero realizar compras seleccionando productos, métodos de envío y formas de pago
  Para recibir mis productos correctamente y disfrutar de una experiencia de compra eficiente.
    ...
    Ejemplos:
      ...
      | nuevo      | normal         | 2        | Entrega hoy        |  nuevo usuario  |  RUT     | Tarjeta de Crédito o Debito con CVV  | diners     | OK   |
