...
import co.com.colcomercio.financiero.interactions.SelectCityInstalacion;
...
import static co.com.colcomercio.financiero.userinterfaces.selectedProductPages.ActionsOnProducrPage.TEXTBOX_CITY_INSTALACION;
...
public class AddProduct implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        } else if (TEXTBOX_CITY_INSTALACION.isVisibleFor(actor)) {
            actor.attemptsTo(
                    SelectCityInstalacion.instalacion()
            );
        }
        actor.attemptsTo(
                WaitUntil.the(BUTTON_GO_TO_PAY_DOS, isVisible()).forNoMoreThan(LOW_TIME).seconds(),
                Wait.withDuration(MICRO_TIME),
