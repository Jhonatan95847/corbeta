...
public class CreditCardPage extends PageObject {
    public static final Target EITBOX_NUMBERCARD_TA =Target.the("Campo Numero de tarjeta alkosto").located(By.xpath("//input[@name=\"cardNumber\"]"));
    public static final Target EITBOX_EXPIRATIONDATE_TA =Target.the("Campo fecha de expiracion").located(By.xpath("//input[@name=\"expirationDate\"]"));
