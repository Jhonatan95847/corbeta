...
public class LoginPage extends PageObject {
    ...
    public static final Target BUTTON_CONTINUE_LOGIN_NEW =Target.the("Boton Continuar Login").located(By.xpath("//div[@class=\"new-autentication-form\"]//button[contains(text(),' Continuar')]"));
