...
public class YourDataPage extends PageObject {
    ...
    public static final Target EITBOX_PHONE_TUSDATOS =Target.the("Campo telefono tus datos").located(By.xpath("//form[@id=\"signInPostForm\"]//div[@class=\"float-input-group phone-input\"]//input[@id=\"phone\"]"));
    ...
    public static final Target CHECK_AUTORIZO =Target.the("Check autorizo").located(By.xpath("//label[@class=\"form-check-label\"]"));
