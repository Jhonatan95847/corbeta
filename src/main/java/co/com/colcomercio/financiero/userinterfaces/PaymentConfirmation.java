...
public class PaymentConfirmation extends PageObject {
    ...
    public static final Target TEXT_NUMERO_PEDIDO =Target.the("Numero de pedido").located(By.xpath("//span[@class=\"order-code order-code--new-confirmation\"]"));
    ...
    public static final Target VALIDATE_FAILED_PAY =Target.the("Texto pago fallido").located(By.xpath("//span[contains(text(),'rechazada')]"));
