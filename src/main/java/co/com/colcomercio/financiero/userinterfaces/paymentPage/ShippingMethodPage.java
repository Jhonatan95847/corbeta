...
public class ShippingMethodPage extends PageObject {
    ...
    public static final Target VALIDATION_TIPO_METODOENVIO =Target.the("Texto tipo de envio").located(By.xpath("//div[@class=\"checkout-shipping-items row\"]//span[contains(text(),' Recoge en tienda')]"));
