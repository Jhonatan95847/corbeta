...
public class ShippingMethodPage extends PageObject {
    public static final Target VALIDATION_METODOENVIO =Target.the("Texto metodo de envio").located(By.xpath("//div[@class=\"checkout-steps__container active\"]//div[text()=' Método de envío']"));
