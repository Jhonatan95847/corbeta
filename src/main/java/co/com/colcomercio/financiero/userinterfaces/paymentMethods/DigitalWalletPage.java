...
public class DigitalWalletPage extends PageObject {
    ...
    public static final Target BUTTON_CONTINUAR_BILLETERA =Target.the("Boton continuar billetera").locatedBy("//div[@class=\"z-content z-active\"]//button[contains(text(),' Continuar')]");
