...
public class CashPaymentPage extends PageObject {
    ...
    public static final Target BUTTON_CPNTINUAR_EFECTIVO =Target.the("Boton Continuar efectivo").locatedBy("//div[@class=\"z-content z-active\"]//button[contains(text(),' Continuar')]");
