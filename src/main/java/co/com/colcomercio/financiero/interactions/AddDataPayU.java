...
public class AddDataPayU implements Interaction {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                //WaitUntil.the(EDITBOX_CVCDATENOMNUM_PAYU.of("Número de la tarjeta"), WebElementStateMatchers.isVisible()).forNoMoreThan(20).seconds(),
                Wait.withDuration(LOW_TIME),
                ScrollToElement.to(EDITBOX_CVCDATENOMNUM_PAYU.of("Número de la tarjeta")),
                EnterText.intoField(paymentCard.getDataPaymentCard().getCardNumber(),EDITBOX_CVCDATENOMNUM_PAYU.of("Número de la tarjeta")),
